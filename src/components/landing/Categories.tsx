          ...
          {CATEGORIES.map((cat, i) => (
            ...
            >
              <Link
                ...
                className="group block overflow-hidden rounded-3xl border border-slate-200/70 bg-white/80 p-7 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-900/5 backdrop-blur"
              >
